...
impl PersistedLocationHandler {
    pub(crate) fn new(last_version_location: Option<StorageLocation>) -> PersistedLocationHandler {
        PersistedLocationHandler {
            ...
            next_version_location(self.last_version_location.clone()),
    ...
    pub(crate) fn start_version(&mut self) -> Result<(), > {
    ...
    pub(crate) fn wait_for_version(&self) -> Option<StorageLocation> {
